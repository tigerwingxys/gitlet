...
class Utils {
	...
	/**
	 * Return the entire contents of FILE as a String. FILE must be a normal
	 * file. Throws IllegalArgumentException in case of problems.
	 */
	...
	/**
	 * Write the result of concatenating the bytes in CONTENTS to FILE, creating
	 * or overwriting it as needed. Each object in CONTENTS may be either a
	 * String or a byte array. Throws IllegalArgumentException in case of
	 * problems.
	 */
